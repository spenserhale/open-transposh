...
**Donate link:** [Donate via PayPal](https://www.paypal.com/donate/?hosted_button_id=S8PSX2BELM3D6)  
**Requires at least:** 6.0  
**Tested up to:** 6.1.1  
**Requires PHP:** 8.1  
**Stable tag:** 2.1.1  
**License:** GPL v3 or later ([License URI](https://www.gnu.org/licenses/gpl-3.0.txt))
...
2. On the Language setting page - choose which languages you would like viewable, translatable and which language is currently used (default) by clicking and dragging
3. On the Settings page - select which user roles can translate
4. You may also elect to disable/enable the automatic translation mode
5. Add the widget to your site, decide which interface you prefer
